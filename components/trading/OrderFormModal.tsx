...
export default function OrderFormModal({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // 信用取引の場合はレバレッジを考慮した資金で判定
        const effectiveCapital =
            tradingType === "margin"
                ? availableCapital * 3.0
                : availableCapital;
        if (orderType === "buy" && calculation.totalCost > effectiveCapital) {
            alert("資金が不足しています");
            return;
        }
    ...
    return (
        ...
        >
            <div className="bg-card rounded-2xl w-full sm:max-w-md flex flex-col border max-h-[90vh] my-auto">
                {/* ヘッダー */}
